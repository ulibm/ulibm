...
?><BR>
<TABLE width=780 align=center bgcolor=white cellspacing=1><td align=right><nobr><a href="exportmarked.php?clear=yeahyeah"><IMG SRC="neoimg/clear.jpg" WIDTH="29" HEIGHT="26" BORDER="0" ALT="" align=absmiddle><B> <?php  echo getlang("ล้างทั้งหมด::l::Clear all"); ?></B></a>&nbsp;<a href=index.php><IMG SRC="neoimg/research.jpg" WIDTH="29" HEIGHT="26" BORDER="0" ALT="" align=absmiddle><B><?php  echo getlang("สืบค้นใหม่::l::New search"); ?></B></a></td>
        </TR>
    </TABLE><TABLE width=780 align=center bgcolor=black cellspacing=1>
<TR bgcolor=#c9c9c9>
...
foreach ($_SESSION['marked'] as $value) {
	...
	<TD>";
	echo "<a href='dublin.php?ID=$value' target=_blank>".(marc_gettitle($value) . "</a>/".marc_getauth($value)."<BR>");
	echo "</TD>
