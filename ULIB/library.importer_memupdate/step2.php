...
barcodeval_set("importer_memupdate-mem_type",$mem_type);
barcodeval_set("importer_memupdate-libsite",$libsite);
barcodeval_set("importer_memupdate-to_room",$to_room);
barcodeval_set("importer_memupdate-sep_rec",$sep_rec);
barcodeval_set("importer_memupdate-sep_field",$sep_field);
barcodeval_set("importer_memupdate-cover_field",$cover_field);
barcodeval_set("importer_memupdate-file",$file);
