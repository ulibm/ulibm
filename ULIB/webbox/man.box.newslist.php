...
if ($setnewscate!=0) {
	tmq("delete from webbox_newslist_catemap where pid='$pid' ");
	tmq("insert into webbox_newslist_catemap set pid='$pid',cate='$setnewscate',displayformat='$displayformat',showcount='$showcount' ");
}
...
?><center><form method="post" action="man.box.newslist.php">
<input type="hidden" name="pid" value="<?php  echo $pid?>">
	...
	?> <input type="submit" value="Save"> <a href="man.box.newslist.cate.php?pid=<?php  echo $pid;?>" class="smaller a_btn"><?php  echo getlang("จัดการ::l::Manage")?></a><br>
	<?php 
	echo getlang("รูปแบบการแสดง::l::Display"); 
	form_quickedit("displayformat",$catemap[displayformat],"list:List,Grid,Grid_2_column");
...
fixform_tablelister($tbname," 1 and cate='$cate' ",$dsp,"yes","yes","yes","pid=$pid&cate=$cate",$c,"  dt desc "," limit 7");
