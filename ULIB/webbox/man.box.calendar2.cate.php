...
html_start();
	 $_REQPERM="webbox";
	 mn_lib();
pagesection(getlang("หัวข้อกิจกรรม::l::Events Category"));
?>
                <div align = "center">
<?php 


$tbname="webbox_calendar2_cate";
...
?><b><a href="man.box.calendar2.php?pid=<?php  echo $pid?>"><center><?php  echo getlang("กลับ::l::Back");?></center></a></b><?php 
