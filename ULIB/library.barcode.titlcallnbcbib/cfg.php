...
mn_lib();
if ($save=='yes') {
	barcodeval_set("BARCODE-titlcallnbcbib-iheight",$iheight);
	barcodeval_set("BARCODE-titlcallnbcbib-iwidth",$iwidth);

	barcodeval_set("BARCODE-titlcallnbcbib-width",$width);
	barcodeval_set("BARCODE-titlcallnbcbib-height",$height);
	barcodeval_set("BARCODE-titlcallnbcbib-text",$text);
	barcodeval_set("BARCODE-titlcallnbcbib-papersize",$papersize);
	barcodeval_set("BARCODE-titlcallnbcbib-str",$str);
	barcodeval_set("BARCODE-titlcallnbcbib-perpage",$perpage);
	barcodeval_set("BARCODE-titlcallnbcbib-allbc",$allbc);
	barcodeval_set("BARCODE-titlcallnbcbib-color",$color);
}
...
<TR  bgcolor=ffffff>
<TD><?php  echo getlang("Bib.ID ที่จะพิมพ์::l::Bib.IDs"); ?></TD>
<TD><?php 
$barcode_manage="BARCODE-titlcallnbcbib-allbc";
include("../library.barcode/globalinc.php");
?><TEXTAREA NAME="allbc" ROWS="9" COLS="25"><?php echo barcodeval_get("BARCODE-titlcallnbcbib-allbc");?></TEXTAREA></TD>
</TR>
<TR  bgcolor=ffffff>
<TD><?php  echo getlang("ความกว้างบาร์โค้ด::l::Barcode Width"); ?></TD>
<TD><INPUT TYPE="text" NAME="width" size=15 value="<?php echo barcodeval_get("BARCODE-titlcallnbcbib-width");?>"></TD>
</TR>
<TR bgcolor=ffffff>
<TD><?php  echo getlang("ความสูงบาร์โค้ด::l::Barcode Height"); ?></TD>
<TD><INPUT TYPE="text" NAME="height" size=15 value="<?php echo barcodeval_get("BARCODE-titlcallnbcbib-height");?>"></TD>
</TR>
<TR  bgcolor=ffffff>
<TD><?php  echo getlang("ความละเอียดบาร์โค้ด (กว้าง)::l::Barcode resolution width"); ?></TD>
<TD><INPUT TYPE="text" NAME="iwidth" size=15 value="<?php echo barcodeval_get("BARCODE-titlcallnbcbib-iwidth");?>"></TD>
</TR>
<TR bgcolor=ffffff>
<TD><?php  echo getlang("ความละเอียดบาร์โค้ด (สูง)::l::Barcode resolution height"); ?></TD>
<TD><INPUT TYPE="text" NAME="iheight" size=15 value="<?php echo barcodeval_get("BARCODE-titlcallnbcbib-iheight");?>"></TD>
</TR>
<TR  bgcolor=ffffff>
<TD><?php  echo getlang("จำนวนบาร์โค้ดต่อคอลัมน์::l::Barcode per column"); ?></TD>
<TD><INPUT TYPE="text" NAME="perpage" size=15 value="<?php echo barcodeval_get("BARCODE-titlcallnbcbib-perpage");?>"></TD>
</TR>


<!-- <TR bgcolor=ffffff>
<TD><?php  echo getlang("ข้อความเพิ่มเติม::l::Text"); ?> </TD>
<TD><INPUT TYPE="text" NAME="str" size=15 value="<?php echo barcodeval_get("BARCODE-titlcallnbcbib-str");?>"></TD>
</TR> -->

<TR bgcolor=ffffff>
<TD><?php 
$color=barcodeval_get("BARCODE-titlcallnbcbib-color");
...
<TD>
<?php 
$text=barcodeval_get("BARCODE-titlcallnbcbib-text");
?>
...
<TD>
<?php 
$papersize=barcodeval_get("BARCODE-titlcallnbcbib-papersize");
?>
