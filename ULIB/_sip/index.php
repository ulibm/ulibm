...
echo \"killing tcp $v\r\";
echo \$ssh->exec('/usr/bin/fuser -k -n tcp $v');
...
echo \$ssh->exec('$dcrs"."_sip/sipServerInitializer.sh > /dev/null 2>/dev/null &');
...
//echo shell_exec(\"$dcrs"."_sip/sipServerInitializer.sh > /dev/null 2>/dev/null &\");
 ...
 ?".">.eof";
	...
	fso_file_write("$dcrs"."/_sip/sipServerInitializer-ssh.php","w+",$resall);
   chmod("$dcrs"."/_sip/sipServerInitializer-ssh.php",0777);
}
?>
                <div align = "center">
<?php 
