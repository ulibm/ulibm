...
class archive
{
	...
	function create_archive()
	{
		...
		if ($this->options['inmemory'] == 0)
		{
			...
			{
				$this->error[] = "Could not open {$this->options['name']} for writing1.";
				chdir($pwd);
				return 0;
			}
		}
	...
	function extract_files()
	{
		...
		if ($fp = $this->open_archive())
		{
            ...
            @chmod($file['name'],0777);
				...
				{//printr($file);
					$this->error[] = "Could not open {$file['name']} for writing2.";
					continue;
				}
...
class gzip_file extends tar_file
{
	...
	function create_gzip()
	{
		if ($this->options['inmemory'] == 0)
		{
			...
			{
				$this->error[] = "Could not open {$this->options['name']} for writing3.";
				chdir($pwd);
				return 0;
			}
		}
...
class bzip_file extends tar_file
{
	...
	function create_bzip()
	{
		if ($this->options['inmemory'] == 0)
		{
			...
			{
				$this->error[] = "Could not open {$this->options['name']} for writing4.";
				chdir($pwd);
				return 0;
			}
		}
