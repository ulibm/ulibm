...
var simpleGallery_navpanel={
	panel: {height:'60px', opacity:0.5, paddingTop:'5px', fontStyle:'bold 11px Tahoma'}, //customize nav panel container
...
simpleGallery.routines={
	...
	getSlideHTML:function(imgelement){
		...
		layerHTML+='<img src="'+imgelement[0]+'" style="border-width:0; width: <?php  echo $set_width;?>; height:<?php  echo $set_height;?>" />'
