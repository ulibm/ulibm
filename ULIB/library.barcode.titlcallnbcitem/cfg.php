...
mn_lib();
if ($save=='yes') {
	barcodeval_set("BARCODE-titlcallnbcitem-iheight",$iheight);
	barcodeval_set("BARCODE-titlcallnbcitem-iwidth",$iwidth);

	barcodeval_set("BARCODE-titlcallnbcitem-width",$width);
	barcodeval_set("BARCODE-titlcallnbcitem-height",$height);
	barcodeval_set("BARCODE-titlcallnbcitem-text",$text);
	barcodeval_set("BARCODE-titlcallnbcitem-papersize",$papersize);
	barcodeval_set("BARCODE-titlcallnbcitem-str",$str);
	barcodeval_set("BARCODE-titlcallnbcitem-perpage",$perpage);
	barcodeval_set("BARCODE-titlcallnbcitem-allbc",$allbc);
	barcodeval_set("BARCODE-titlcallnbcitem-color",$color);
}
...
<TD><?php 
$barcode_manage="BARCODE-titlcallnbcitem-allbc";
include("../library.barcode/globalinc.php");
?><TEXTAREA NAME="allbc" ROWS="9" COLS="25"><?php echo barcodeval_get("BARCODE-titlcallnbcitem-allbc");?></TEXTAREA></TD>
</TR>
<TR  bgcolor=ffffff>
<TD><?php  echo getlang("ความกว้างบาร์โค้ด::l::Barcode Width"); ?></TD>
<TD><INPUT TYPE="text" NAME="width" size=15 value="<?php echo barcodeval_get("BARCODE-titlcallnbcitem-width");?>"></TD>
</TR>
<TR bgcolor=ffffff>
<TD><?php  echo getlang("ความสูงบาร์โค้ด::l::Barcode Height"); ?></TD>
<TD><INPUT TYPE="text" NAME="height" size=15 value="<?php echo barcodeval_get("BARCODE-titlcallnbcitem-height");?>"></TD>
</TR>
<TR  bgcolor=ffffff>
<TD><?php  echo getlang("ความละเอียดบาร์โค้ด (กว้าง)::l::Barcode resolution width"); ?></TD>
<TD><INPUT TYPE="text" NAME="iwidth" size=15 value="<?php echo barcodeval_get("BARCODE-titlcallnbcitem-iwidth");?>"></TD>
</TR>
<TR bgcolor=ffffff>
<TD><?php  echo getlang("ความละเอียดบาร์โค้ด (สูง)::l::Barcode resolution height"); ?></TD>
<TD><INPUT TYPE="text" NAME="iheight" size=15 value="<?php echo barcodeval_get("BARCODE-titlcallnbcitem-iheight");?>"></TD>
</TR>
<TR  bgcolor=ffffff>
<TD><?php  echo getlang("จำนวนบาร์โค้ดต่อคอลัมน์::l::Barcode per column"); ?></TD>
<TD><INPUT TYPE="text" NAME="perpage" size=15 value="<?php echo barcodeval_get("BARCODE-titlcallnbcitem-perpage");?>"></TD>
</TR>


<!-- <TR bgcolor=ffffff>
<TD><?php  echo getlang("ข้อความเพิ่มเติม::l::Text"); ?> </TD>
<TD><INPUT TYPE="text" NAME="str" size=15 value="<?php echo barcodeval_get("BARCODE-titlcallnbcitem-str");?>"></TD>
</TR> -->
