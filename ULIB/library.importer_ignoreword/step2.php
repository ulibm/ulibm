...
?>
<BR>
<?php  echo getlang("ด้านล่างเป็นรายการตัวอย่างการดึงข้อมูลจากไฟลดืที่เลือก ด้วยรายละเอียดที่คุณกรอก <BR>
...
?><BR>
<?php  echo getlang(" ในการนำเข้าข้อมูลแต่ละครั้ง จะทำการนำเข้าเพียง 50,000 รายการ.::l::Only first 50,000 records will be import to import process"); ?></CENTER><BR>
<?php 
foot();
?>