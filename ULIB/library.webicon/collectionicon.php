<?php 
	; 
		...
		head();
		$_REQPERM="webicon-collectionicon";
        $tmp=mn_lib();
$dir="neoimg/collectionicon/";
...
?> 
<TABLE width=770 align=center bgcolor=888888 cellpadding=1 cellspacing=1 border=0 class=table_border>
<TR  bgcolor=f2f2f2>
