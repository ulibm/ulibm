                            ...
                            <td>
                                <form name = "form1" method = "post" action = "addMedia_typeAction.php">
                                    <table width = "780" border = "0" cellspacing = "1" cellpadding = "4" align = "center" bgcolor = e3e3e3>
                                        ...
                                        <tr bgcolor = "#f3f3f3">
                                            <td width = "27%" valign = "middle">
                                                <font face = "MS Sans Serif" size = "2"><?php echo getlang("ข้อความด่วน::l::Quick text"); ?><br> <?php echo getlang("1 บรรทัดต่อ 1 รายการ::l::1 per line"); ?></font></td>
                                            <td width = "73%">
                                                <font face = "MS Sans Serif" size = "2"><textarea name="quicktext" rows="3" cols="50"></textarea> </font></td>
                                        </tr>
                                        <tr bgcolor = "#f3f3f3">
                                            <td width = "27%" valign = "middle">
