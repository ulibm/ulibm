...
function savesnap() {
	self.location="saveaction.php?id=<?php  echo $id?>";
}
function preview(wh) {
	//wh=wh.replace('url:','');
	dsp=getobj("dspdsp");
	dsp.innerHTML="<img src='./file/temp<?php  echo $useradminid?>.jpg?"+Math.random()+"' width=128 border=1 bordercolor=999999><BR><A HREF='javascript:savesnap()'>Save Picture</A>";
