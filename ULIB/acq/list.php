...
function localview($wh) {
	global $_s;
	$s= "<A HREF='./sub.php?pid=$wh[id]'><B>".stripslashes($wh[name])."</B> ($wh[yea]) <FONT class=smaller color=black>".stripslashes($wh[descr])."</A> ";
	$s.="";
	return $s;
}
...
<center>ลิงค์สำหรับผู้ใช้บริการ : <a href="./req/">เลือกหนังสือโดยรายการ</a> : <a href="./req/suggest.php">แนะนำรายการใหม่</a><br>

<a href="./req/listbystatus.php?mode=reject">หนังสือขาดตลาด/ไม่จัดพิมพ์</a>
:
<a href="./req/listbystatus.php?mode=ordering">กำลังดำเนินการสั่งซื้อ</a>
</center><br><br>
<?php 
foot();
?>