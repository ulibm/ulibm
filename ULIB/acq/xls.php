...
<tr>
	<td colspan=11 align=center height=82 style="text-align:center; border-width:0px;"><IMG src="<?php  echo $dcrURL;?>/logo.jpg" width="400" height="80" border="0" alt="" style="margin: 2px 2px 2px 2px;">
	</td>
</tr>
<tr>
