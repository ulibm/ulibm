...
class ExcelWriterXML_Style {
     ...
     * Microsoftฎ Internet Explorer named colors
	...
	public function border(
		...
		,$weight = '1'				// 0ืHairline, 1ืThin, 2ืMedium, 3ืThick
		,$color = 'Automatic'		// Automatic, 6-hexadecimal digit number in "#rrggbb" format or it can be any of the Microsoftฎ Internet Explorer named colors
