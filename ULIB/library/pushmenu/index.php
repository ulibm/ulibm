...
*/
if ($movetomenubar=="yes") {
   barcodeval_set("personalsetting-o-pushmenulocation-$useradminid",addslashes("Menu Bar"));
   ?>
   <script>
   top.location="<?php echo $dcrURL;?>library/mainadmin.php";</script>
   <?php
   die;
}
...
while ($r=tfa($s)) {
		...
		//printr($r2);
								...
								if ($thisperm2==true && $r2[url]!="") {
									...
									$url="<A HREF='$r2[url]' style='font-size:16px;width: 100%; display: block;' target=_top>  ";
								}
								if ($r2[url]=="" ) {
...
?><table>
<tr>
	<td><a href="index.php?ordr=up&ordrid=<?php  echo $r[id];?>"><img src="../../neoimg/Up.gif" width="16" height="16" border="0" alt=""></a></td>
	<td><a href="index.php?delete=<?php  echo $r2[code];?>" onclick="return confirm('Confirm delete?');"><img src="../../neoimg/Delete.gif" width="16" height="16" border="0" alt=""></a></td>
</tr>
<tr>
	<td><a href="index.php?ordr=down&ordrid=<?php  echo $r[id];?>"><img src="../../neoimg/Down.gif" width="16" height="16" border="0" alt=""></a></td>
	<td></td>
</tr>
</table><?php 
								echo "</td>
...
<a href="<?php echo $dcrURL;?>library/pushmenu/index.php?loadbasicmenu=yes" class='a_btn smaller2' target=_self><?php echo getlang("โหลดเมนูพื้นฐาน::l::Load basic menu"); ?></a><BR>
<a href="<?php echo $dcrURL;?>library/pushmenu/index.php?movetomenubar=yes" class='a_btn smaller2' target=_self><?php echo getlang("ย้ายเมนูด่วนไปที่เมนูบาร์::l::Move push menu to menu bar"); ?></a><BR>
