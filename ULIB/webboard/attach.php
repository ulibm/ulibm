...
if ($remove!="") {
	$remq=tmq("select * from webboard_post_attatch where tmid='$_tmid' and postid=$loadedit and id='$remove'");
	...
	tmq("delete from  webboard_post_attatch where tmid='$_tmid' and postid=$loadedit and id='$remove' ");
}
...
<?php 
$s=tmq("select * from  webboard_post_attatch where tmid='$_tmid' and postid=$loadedit ");
