<?php  
	...
	mn_lib();
	pagesection(getlang("รายงานหนังสือทั้งหมดในหมวดหมู่ DC::l::Books in DC Classifications"));
?>
    <table width = "780" align=center border = "0" cellspacing = "0" cellpadding = "0">
        ...
        <table width = "100%" border = "0" cellspacing = "1" cellpadding = "10">
            ...
            <tr align = "center">
                <td colspan = "3">
                    <table width = "780"  class=table_border border = "0" cellspacing = "1" cellpadding = "3" >
                        <tr  class=table_head>
                            <td width = "9%"><b><font face = "MS Sans Serif" size = "2"><?php echo getlang("ลำดับที่::l::No."); ?></font></b></font></td>
                            <td width = "" align = center><b><font face = "MS Sans Serif" size = "2"><nobr><?php echo getlang("หมวดของวัสดุสารสนเทศ::l::Classification"); ?></font></b></font></td>
                            <td width = 20% colspan = 1><b><font face = "MS 
...
<font color = "#FFFFFF"><b><font face = "MS Sans Serif" size = "2"></font></b></font></td><td></td>
            ...
            <?php  
                ...
                while ($i < $ticker)
                    ...
                    //echo tmq_error();
					/*
                    $sql1="$sql1 (" . getval("stat","dc_tagname") . ") like '$prefDcsearch^a$iff2%'";
                    $sql1="$sql1 or (" . getval("stat","dc_tagname") . ") like '$prefDcsearch$iff2%'";
                    $sql1="$sql1 or (" . getval("stat","dc_tagname") . ") like '$prefDcsearch$prefDcsearch$iff2%'";
                    $sql1="$sql1 or (" . getval("stat","dc_tagname") . ") like '$prefDcsearch$prefDcsearch^a$iff2%'";*/
					 $sql1="$sql1 (" . getval("stat","dc_tagname") . ") like '%^a$iff2%'";
					 $sql1="$sql1 or (" . getval("stat","dc_tagname") . ") like '%$iff2"."__.%'";
                    //echo $sql1 . "<BR>";
                ...
                while ($i < $ticker)
                    ...
                    echo "<td><font face='MS Sans Serif' size=2>  $iff2"."00</font></td>";
