...
barcodeval_set("importer_bkitems-status",$status);
barcodeval_set("importer_bkitems-bcsep_field",$bcsep_field);
barcodeval_set("importer_bkitems-itemtype",$itemtype);
barcodeval_set("importer_bkitems-itemplace",$itemplace);
barcodeval_set("importer_bkitems-libsite",$libsite);
barcodeval_set("importer_bkitems-sep_rec",$sep_rec);
barcodeval_set("importer_bkitems-sep_field",$sep_field);
barcodeval_set("importer_bkitems-cover_field",$cover_field);
barcodeval_set("importer_bkitems-importset",$importset);
barcodeval_set("importer_bkitems-file",$file);
...
$reclist=fso_file_importmelt($fpath,10,10000,$sep_rec,$sep_field,$cover_field);
...
<?php  echo getlang("1. เฉพาะ 50 ฟิลด์แรกเท่านั้นที่จะทำการดึงเข้าฐานข้อมูลเพื่อการนำเข้าข้อมูล::l::1. Only first 50 fields will import to import process"); ?>,<BR>
<?php  echo getlang("2. ในการนำเข้าข้อมูลแต่ละครั้ง จะทำการนำเข้าเพียง 5,000 รายการ.::l::2. Only first 5,000 records will be import to import process"); ?>
<BR></CENTER>
<?php 
foot();
?>