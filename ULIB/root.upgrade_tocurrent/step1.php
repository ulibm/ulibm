...
if ($ui_collation!="") {
	...
	barcodeval_set("root_upgradetocurrent_coll",$ui_collation);
	barcodeval_set("root_upgradetocurrent_host",$ui_host);
	barcodeval_set("root_upgradetocurrent_user",$ui_user);
	barcodeval_set("root_upgradetocurrent_passwd",$ui_passwd);
	barcodeval_set("root_upgradetocurrent_dbname",$ui_dbname);}
