...
$timebarwidth=floor($timebarwidth);
if ($timebarwidth==0) {
	$timebarwidth=800;
}
// พ 
...
var barwidth=<?php  echo $timebarwidth;?>;                  // WIDTH OF THE BAR IN PIXELS
var waitTime=<?php  echo barcodeval_get("havester-secinterval");?>;                   // NUMBER OF SECONDS FOR PROGRESSBAR
