...
arrowimages: {down:['downarrowclass', '<?php  echo $dcrURL;?>library.webbox.cascademenu/smoothmenu/down.gif', 23], right:['rightarrowclass', '<?php  echo $dcrURL;?>library.webbox.cascademenu/smoothmenu/right.gif', 6]},
