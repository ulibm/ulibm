...
unset($_REQUEST["ulib_libmaintab"]);

/**
 * An array for collecting erros which can be reported later. It will be checked before a new action is taken.
 */
//require_once("../inc/config.inc.php");
//$_ULIBOBJID_="vecelibrary";
//require_once("../_SOURCEULIB/inc/config.inc.php");
require_once("../inc/config.inc.php");
if (strtolower(getval("oaiconfig","isenable"))!="yes") {
	///die("OAI Disabled by configuration.");
}
