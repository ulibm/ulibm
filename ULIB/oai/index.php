...
$MY_URI = 'http://'.$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT'].$_SERVER['SCRIPT_NAME'];
//$MY_URI = 'view-source:'.$_SERVER['SERVER_NAME'].":".$_SERVER['SERVER_PORT'].$_SERVER['SCRIPT_NAME'];
$pos = strrpos($MY_URI, '/');
...
<html>
<head>
<title>ULib-oai2 Data Provider</title>
</head>
<body>

<h3>ULib-oai2 Data Provider</h3>
<p>This is an implementation of <a href="https://code.google.com/p/oai-pmh-2/" target="_blank">oai-pmh-2</a></p>

<dl>
	<dt>Data-Provider</dt>
		<dd><a target=_blank href="<?php  echo $MY_URI; ?>?verb=Identify">Identify</a></dd>
		<dd><a target=_blank href="<?php  echo $MY_URI; ?>?verb=ListMetadataFormats">ListMetadataFormats</a></dd>
		<dd><a target=_blank href="<?php  echo $MY_URI; ?>?verb=ListSets">ListSets</a></dd>
		<dd><a target=_blank href="<?php  echo $MY_URI; ?>?verb=ListIdentifiers&amp;metadataPrefix=oai_dc">ListIdentifiers</a></dd>
		<dd><a target=_blank href="<?php  echo $MY_URI; ?>?verb=ListRecords&amp;metadataPrefix=oai_dc">ListRecords</a></dd>
		<dd><a target=_blank href="<?php  echo $MY_URI; ?>?verb=GetRecord&amp;metadataPrefix=oai_dc&amp;identifier=1">GetRecord</a></dd>
	</dt>
</dl>
</p>
