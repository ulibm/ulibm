...
$tmp=mn_lib();
if ($act=="add") {
	tmq("insert into libsite_bibpermission set libfrom='$libsite' , libto='$libto',code='$code'  ");
}
if ($act=="close") {
	tmq("delete from libsite_bibpermission where libfrom='$libsite' and libto='$libto' and code='$code'  ");
}
...
<?php 
	...
	/////////////////
$s=tmq("select * from libsite_bibmodules order by name");
?><TABLE class=table_border width=780 align=center><?php 
while ($r=tmq_fetch_array($s)) {
	...
	<TD>
	<?php 
	$tmp=tmq("select * from libsite_bibpermission where libfrom='$libsite' and libto='$r3[code]' and code='$r[code]'  ");	
