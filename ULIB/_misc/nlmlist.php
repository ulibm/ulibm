...
?><TABLE cellpadding=0 cellspacing=0 class=table_border width=100%>
	...
	<?php 
		 ...
		 while ($subr=tmq_fetch_array($sub)) {
			 ...
			 echo " ";
				 ...
				 if ("$class1"=="$i") {
		 		 ...
		 		 echo "<a href='nlmlist.php?parentjsid=$parentjsid&class1=$i'>";
		 		 echo $class1name;
				 echo "</a>";
			 		echo "</b>";
		 }
		...
		?>
		 <a href='nlmlist.php?parentjsid=<?php  echo $parentjsid?>&class1='> back </a>
		<?php  } ?>
	</TD>
</TR>
<?php 	if ($class1!="") {?>
	...
	<?php 
		 ...
		 $sub=tmq("select distinct substring(num,2,1) as aa from $tbname where num like '$class1%' ",false);
		 while ($subr=tmq_fetch_array($sub)) {
			 $i=$subr[aa];
		  	 ...
		  	 echo " ";
				 ...
				 if ("$class2"=="$i") {
		 		 ...
		 		 echo "<a href='nlmlist.php?parentjsid=$parentjsid&class1=$class1&class2=$i'>";
		 		 echo $class2name;
				 echo "</a>";
		 		echo "</b>";
		 }
			 ...
			 $i=$subr[aa];
		  	 echo " ";
				 ...
				 if ("$class3"=="$i") {
		 		 ...
		 		 echo "<a href='nlmlist.php?parentjsid=$parentjsid&class1=$class1&class2=$class2&class3=$i'>";
		 		 echo $class3name;
				 echo "</a>";
		 		echo "</b>";
...
function localclicker($wh) {
	 ...
	 $wh[num]=trim($wh[num]);
	if ($class1=="") {
		$limit="<a href='nlmlist.php?parentjsid=$parentjsid&class1=".substr($wh[num],0,1)."'>";
	} else {
		if ($class2=="") {
				 $limit="<a href='nlmlist.php?parentjsid=$parentjsid&class1=$class1&class2=".substr($wh[num],1,1)."'>";
		} else {
			if ($class3=="") {
				 $limit="<a href='nlmlist.php?parentjsid=$parentjsid&class1=$class1&class2=$class2&class3=".substr($wh[num],2,1)."'>";
			} else {
				 $limit="";
			}
		}
...
fixform_tablelister($tbname," $limit  ",$dsp,"no","no","no","class1=$class1&class2=$class2&class3=$class3&parentjsid=$parentjsid",$c," length(num)",$o);
?>