...
for ($i=1;$i<=1;$i++) {
	...
	$pdf->Cell(535,30,iconvth("รายชื่อผู้ค้างชำระค่าปรับ/ค่าใช้จ่าย"),1,0,'C');
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	$pdf->SetFont('Tahoma','',12);
				$sql="select * from fine where memberId='$id' and isdone<>'yes' order by id asc";
		$result=tmq($sql);
		$cc=0;
				$pdf->SetXY(27,$pdf->GetY()+5);
		while ($row = tmq_fetch_array($result)) {
				...
				$pdf->Cell(365,20,(substr(iconvth($row[topic]),0,50)),1);
