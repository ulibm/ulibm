<?php  //พ
   ...
   echo "\xEF\xBB\xBF"; //UTF-8 BOM
	...
	echo "Barcode,Name,email,descr,type,statusactive,address,address2,tel,prefi,ExpirationDate,room,major,countlogin,LibrarySite,credit,".getlang($custdb[cust01]).",".getlang($custdb[cust02]).",".getlang($custdb[cust03]).",".getlang($custdb[cust04]).",".getlang($custdb[cust05]).",$newline";
