...
<script type="text/javascript" src="simplegallery.js.php?set_width=<?php  echo $set_width?>&set_height=<?php  echo $set_height;?>">
...
var mygallery=new simpleGallery({
	...
	dimensions: [<?php  echo $set_width;?>, <?php  echo $set_height;?>], //width/height of gallery in pixels. Should reflect dimensions of the images exactly
	imagearray: [
<?php 
