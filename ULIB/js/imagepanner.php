...
var ddimagepanner={
	...
	magnifyicons: ['<?php  echo $dcrURL?>js/imagepanner-magnify.gif','<?php  echo $dcrURL?>js/imagepanner-magnify2.gif', 24,23], //set path to zoom in/out images, plus their dimensions
