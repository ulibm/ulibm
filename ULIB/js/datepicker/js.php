...
var WeekHeadColor="#000000";//Background Color in Week header.
var SundayColor="#FFEBD9";//Background color of Sunday.
...
var ThemeBg="#555555";//Background image of Calendar window.
...
var MonthName=["<?php echo $thaimonstr[1];?>", "<?php echo $thaimonstr[2];?>", "<?php echo $thaimonstr[3];?>", "<?php echo $thaimonstr[4];?>", "<?php echo $thaimonstr[5];?>", "<?php echo $thaimonstr[6];?>","<?php echo $thaimonstr[7];?>","<?php echo $thaimonstr[8];?>", "<?php echo $thaimonstr[9];?>", "<?php echo $thaimonstr[10];?>", "<?php echo $thaimonstr[11];?>", "<?php echo $thaimonstr[12];?>"];
var WeekDayName1=["<?php echo $thaidayshortstr[0];?>","<?php echo $thaidayshortstr[1];?>","<?php echo $thaidayshortstr[2];?>","<?php echo $thaidayshortstr[3];?>","<?php echo $thaidayshortstr[4];?>","<?php echo $thaidayshortstr[5];?>","<?php echo $thaidayshortstr[6];?>"];
var WeekDayName2=["<?php echo $thaidayshortstr[1];?>","<?php echo $thaidayshortstr[2];?>","<?php echo $thaidayshortstr[3];?>","<?php echo $thaidayshortstr[4];?>","<?php echo $thaidayshortstr[5];?>","<?php echo $thaidayshortstr[6];?>","<?php echo $thaidayshortstr[0];?>"];
...
function NewCssCal(pCtrl,pFormat,pScroller,pShowTime,pTimeMode,pHideSeconds) {
	...
	exDateTime=document.getElementById(pCtrl+"_dat").value+"-"+document.getElementById(pCtrl+"_mon").value+"-"+document.getElementById(pCtrl+"_yea").value;
	//alert(exDateTime);
...
function RenderCssCal(bNewCal) {
	...
	vCalHeader="<table "+CalBgColor+" background='"+ThemeBg+"' border=0 bordercolor=#FFFFFF cellpadding=1 cellspacing=1 width='200' valign='top'>\n";
	//Table for Month & Year Selector
	vCalHeader+="<tr bgcolor=white>\n<td colspan='7'>\n<table border=0 width=200 cellpadding=0 cellspacing=0>\n<tr>\n";
  ...
  {	
    if (UseImageFiles)
    {
  		vCalHeader+="<td><img onmousedown='javascript:Cal.DecYear();RenderCssCal();' src='<?php  echo $dcrURL?>js/datepicker/images/cal_fastreverse.gif' width='13' height='9' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>\n";//Year scroller (decrease 1 year)
  		vCalHeader+="<td><img onmousedown='javascript:Cal.DecMonth();RenderCssCal();' src='<?php  echo $dcrURL?>js/datepicker/images/cal_reverse.gif' width='13' height='9' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>\n";//Month scroller (decrease 1 month)
  		vCalHeader+="<td width='70%' class='calR'><font color='"+MonthYearColor+"'>"+Cal.GetMonthName(ShowLongMonth)+" "+(Cal.Year+543)+"</font></td>\n"//Month and Year
  		vCalHeader+="<td><img onmousedown='javascript:Cal.IncMonth();RenderCssCal();' src='<?php  echo $dcrURL?>js/datepicker/images/cal_forward.gif' width='13' height='9' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>\n";//Month scroller (increase 1 month)
  		vCalHeader+="<td><img onmousedown='javascript:Cal.IncYear();RenderCssCal();' src='<?php  echo $dcrURL?>js/datepicker/images/cal_fastforward.gif' width='13' height='9' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td>\n";//Year scroller (increase 1 year)
  	    calHeight += 22;
	  }
	  else
	  {
  ...
  //******************End Month and Year selector in arrow******************************
	...
	if ((ShowMonthYear)&&(Cal.Scroller=="DROPDOWN")) {
		vCalHeader+="<tr><td colspan='7' class='calR'>\n<font color='"+MonthYearColor+"' style='color:"+MonthYearColor+"'>"+Cal.GetMonthName(ShowLongMonth)+" "+Cal.Year+"</font>\n</td></tr>\n";
	    calHeight += 19;
	}
	//Week day header
	...
	for (j=1;j<=Cal.GetMonDays();j++) {
		...
		if ((j==dtToday.getDate())&&(Cal.Month==dtToday.getMonth())&&(Cal.Year==dtToday.getFullYear()))
			strCell=GenCell(j,true,"#000000");//Highlight today's date //TodayColor
		else {
	...
	if (Cal.ShowTime) 
	{
		...
		if (ShowArrows && UseImageFiles) {
		   vCalTime+="</td>\n<td align='center'><table cellspacing='0' cellpadding='0' style='line-height:0pt'><tr><td><img onmousedown='javascript:Cal.SetMinute(parseInt(Cal.Minutes,10) + 1);RenderCssCal();' src='<?php  echo $dcrURL?>js/datepicker/images/cal_plus.gif' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr><tr><td><img onmousedown='javascript:Cal.SetMinute(parseInt(Cal.Minutes,10) - 1);RenderCssCal();' src='<?php  echo $dcrURL?>js/datepicker/images/cal_minus.gif' width='13px' height='9px' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white'></td></tr></table>"; 
		}
	...
	if (UseImageFiles)
	{
        vCalTime+="<B onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\");' class=smaller2 style='cursor: hand; cursor: pointer;'><img onmousedown='javascript:closewin(\"" + Cal.Ctrl + "\");' src='<?php  echo $dcrURL?>js/datepicker/images/cal_close.gif' width='16' height='14' onmouseover='changeBorder(this, 0)' onmouseout='changeBorder(this, 1)' style='border:1px solid white' align=absmiddle> <?php echo getlang("ปิด::l::Close")?></B></td>";
    }
    else
    {
	...
	if (winCal == undefined) {
	   ...
	   with (span.style) {position = "absolute"; left = (xpos+8)+'px'; top = (ypos-8)+'px'; width = CalWidth; border = "solid 0pt " + SpanBorderColor; padding = "0pt"; cursor = "move"; backgroundColor = SpanBgColor; zIndex = 100; }
...
function GenCell(pValue,pHighLight,pColor) { //Generate table cell with value
	...
	if (pColor!=null)
	    ...
	    if ((pHighLight!=null)&&(pHighLight)) {
		   vHLstr1="<font class='calR' color=white style='color: white;'>";vHLstr2="</font>"; vHlbg="black";
		 }
	    else {
		   vHLstr1="";vHLstr2="";
		 }
	if (Cal.ShowTime) {
		...
		vTimeStr="";		
	if (PValue!="")
		PCellStr="\n<td "+vColor+" class='calTD' style='cursor: hand; cursor: pointer; background-color: "+vHlbg+"' onClick=\"javascript:callback('"+Cal.Ctrl+"','"+Cal.FormatDate(PValue)+"');\">"+vHLstr1+PValue+vHLstr2+"</td>";
	else
