...
var arrowheadimg=["<?php  echo $dcrURL?>js/balloontip/arrowdown.gif", "<?php  echo $dcrURL?>js/balloontip/arrowup.gif"] //path to down and up arrow images
...
*/
addEvent(window, 'load', function(){ initalizetooltip() });
