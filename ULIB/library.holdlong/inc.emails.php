<?php 
	...
	$source_db=tmq("select * from holdlong_notif where setid='$setid' ",false);
	$num=number_format(tmq_num_rows($source_db));
	?><CENTER><?php 
	echo getlang("ส่งอีเมล์ทวงถามถึงผู้รับ $num ฉบับ::l::Send $num notification emails ");
	...
	<FORM METHOD=POST ACTION="emailsaction.php">
		...
		echo stripslashes(barcodeval_get("holdlongnotif-email-mailsubj"));
		?>" size=60></TD>
	</TR>
	<TR>
		...
		echo stripslashes(barcodeval_get("holdlongnotif-email-mailbody"));
		?></TEXTAREA></TD>
	</TR>
	<TR>
	...
	<TR>
		...
		[HOLDINGLIST]=<?php echo getlang("รายการทรัพยากรที่ถูกยืม::l::Holding materials list");?><BR>
