...
head();
if ($setstat=="bookrecieve") {
	$_REQPERM="acqxls_setstatus";
} else {
	$_REQPERM="acqxls_setstatus_reject";
}
mn_lib();
...
<tr>
	<td>อีเมล์</td>
	<td class=table_td><a target=_blank href="mailto:<?php  echo $r[s_email]?>?subject=ความคืบหน้าการแนะนำสั่งซื้อ&body=<?php  
	$body="ชื่อเรื่อง $r[titl]%0A%0A
