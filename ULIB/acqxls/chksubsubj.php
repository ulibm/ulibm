...
:
	<?php 
		echo "<a href=\"xls.php?pid=$pid&mode=&subj=$orig\" target=_blank>".$_s[all][name]."</a> ".number_format(tnr(tmq("select id from acqn_sub where pid='$pid' and s_subj='$subj'")));
		echo " : <a href=\"xls.php?pid=$pid&mode=ordering&subj=$orig\" target=_blank>".$_s[ordering][name]."</a> ".number_format(tnr(tmq("select id from acqn_sub where pid='$pid' and stat='ordering' and s_subj='$subj'")));
		echo " : <a href=\"xls.php?pid=$pid&mode=reject&subj=$orig\" target=_blank>".$_s[reject][name]."</a> ".number_format(tnr(tmq("select id from acqn_sub where pid='$pid' and stat='reject' and s_subj='$subj'")));
		echo " : <a href=\"xls.php?pid=$pid&mode=duplicate&subj=$orig\" target=_blank>".$_s[duplicate][name]."</a> ".number_format(tnr(tmq("select id from acqn_sub where pid='$pid' and stat='duplicate' and s_subj='$subj'")));
		echo " : <a href=\"xls.php?pid=$pid&mode=suggest&subj=$orig\" target=_blank>".$_s[suggest][name]."</a> ".number_format(tnr(tmq("select id from acqn_sub where pid='$pid' and stat='suggest' and s_subj='$subj'")));
		echo " : <a href=\"xls.php?pid=$pid&mode=bookrecieve&subj=$orig\" target=_blank>".$_s[bookrecieve][name]."</a> ".number_format(tnr(tmq("select id from acqn_sub where pid='$pid' and stat='bookrecieve' and s_subj='$subj'")));
	?><style>
* {
