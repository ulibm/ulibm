...
v1.7	07-18-04
	...
	fixed numerous smaller bugs (thanks to S๖ren Fuhrmann of golem.de)
	improved changing ATOM versions handling (thanks to August Trometer)
	improved the UniversalFeedCreator's useCached method (thanks to S๖ren Fuhrmann of golem.de)
	added charset output in HTTP headers (thanks to S๖ren Fuhrmann of golem.de)
	added Slashdot namespace to RSS 1.0 (thanks to S๖ren Fuhrmann of golem.de)
...
v1.5.1	01-27-04
	fixed some RSS 1.0 glitches (thanks to St้phane Vanpoperynghe)
