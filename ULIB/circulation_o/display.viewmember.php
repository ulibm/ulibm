...
<!-- 	<TR>
	...
	<center><BR>
<a href="index.php" target=_top style="font-weight: bold; font-size: 18px; color: darkred;"><?php  echo getlang("กดปุ่ม F5 หรือคลิกที่นี่เพื่อเริ่มรายการใหม่::l::Press F5 or click here to start new session"); ?></a>
</center>
	</TD>
</TR>
</TABLE>