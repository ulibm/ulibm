...
<TR>
	<TD class=table_td><INPUT TYPE="text" NAME="memberbarcode" ID="memberbarcode" style="width:100%; background-image:url(user-icon.png); background-repeat: no-repeat; padding-left: 22px;" AUTOCOMPLETE=off><BR><INPUT TYPE="submit" value=" OK "> 
