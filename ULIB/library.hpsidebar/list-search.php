...
function localmanage($wh) {
	if ($wh[type]=="html") {
		return "<CENTER><A HREF='list_content.php?locate=search&id=$wh[id]'><B>".getlang("จัดการเนื้อหา::l::Manage")."</B></A></CENTER>";
	}
	if ($wh[type]=="rss") {
		return "<CENTER><A HREF='list_url.php?locate=search&id=$wh[id]'><B>".getlang("แก้ไขการเชื่อมโยง RSS::l::Edit RSS Url")."</B></A></CENTER>";
	}
	if ($wh[type]=="tab") {
...
fixform_tablelister($tbname," 1 and locate='search' ",$dsp,"yes","yes","yes","locate=search",$c," ordr ");
